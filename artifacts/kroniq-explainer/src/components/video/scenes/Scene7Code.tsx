...
const lines: Array<{ tokens: Array<{ text: string; color: string }> }> = [
  ...
  { tokens: [{ text: '  model', color: '#e06c75' }, { text: ': ', color: '#abb2bf' }, { text: "'claude-3-5-sonnet'", color: '#22c55e' }, { text: ',', color: '#abb2bf' }] },
...
export function Scene7Code() {
  ...
  return (
    <motion.div
      ...
      exit={{ scale: 1.3, opacity: 0, filter: 'blur(30px)', transition: { duration: 0.2, ease: [0.4, 0, 1, 1] } }}
      transition={{ duration: 0.45, ease: [0.16, 1, 0.3, 1] }}
    >
      <motion.div className="glass-panel w-[62vw] overflow-hidden">
        {/* Editor titlebar */}
        ...
        <div className="p-[2vw] font-mono text-[1.35vw] leading-[1.8] min-h-[38vh]"
          ...
          <div className="flex">
            ...
            <motion.span
              className="inline-block w-[0.85vw] h-[1.6vw] bg-white/70 align-middle"
              animate={{ opacity: [1, 0] }}
