...
const panels = [
  {
    ...
    content: () => (
      <div className="flex flex-col gap-[2vh] w-full">
        <div className="glass-input px-[1.5vw] py-[1.4vh] self-end max-w-[80%]" style={{ background: 'rgba(255,255,255,0.10)' }}>
...
export function Scene4ChatPan2() {
  return (
    <motion.div
      ...
      exit={{ scale: 1.12, opacity: 0, filter: 'blur(25px)', transition: { duration: 0.2, ease: [0.4, 0, 1, 1] } }}
