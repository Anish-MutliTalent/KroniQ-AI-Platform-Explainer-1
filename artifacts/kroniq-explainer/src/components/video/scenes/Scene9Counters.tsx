...
function Counter({
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => { frame = requestAnimationFrame(tick); }, delay);
    return () => { clearTimeout(t); cancelAnimationFrame(frame); };
  }, [endValue, delay]);

  return (
    <motion.div
      className="glass-panel w-[26vw] h-[32vh] flex flex-col items-center justify-center relative overflow-hidden"
...
export function Scene9Counters() {
  return (
    <motion.div
      ...
      exit={{ scale: 1.2, opacity: 0, filter: 'blur(25px)', transition: { duration: 0.2, ease: [0.4, 0, 1, 1] } }}
    ...
    >
      ...
      <div className="flex gap-[2.5vw] mb-[7vh] z-10">
        ...
        <Counter endValue={1} label="Tab Open" labelColor="rgba(255,255,255,0.5)" delay={150} />
        <Counter endValue={0} label="Switching" labelColor="rgba(255,255,255,0.5)" delay={300} />
      </div>
