...
export function Scene3ChatPan1() {
  return (
    ...
    >
      {/* Slow camera zoom/dolly wrapper */}
      <motion.div 
      ...
      >
        ...
        <motion.div
          ...
          initial={{ x: '15vw' }}
          animate={{ x: '-185vw' }}
          transition={{ duration: 3.5, ease: [0.25, 0.1, 0.25, 1] }} // Speeds up the pan
        >
            ...
            >
              ...
              <div className="glass-panel w-[44vw] h-[72vh] flex flex-col relative z-10 shadow-[0_20px_50px_-5px_rgba(0,0,0,0.5)]">
                ...
                <div className="flex-1 px-[2vw] py-[2vh] flex flex-col gap-[2.5vh] overflow-hidden">
                  {/* User bubble */}
                  <div className="self-end glass-input px-[1.6vw] py-[1.4vh] max-w-[78%]" style={{ background: 'rgba(255,255,255,0.05)' }}>
